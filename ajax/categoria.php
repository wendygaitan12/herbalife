...
switch ($_GET["op"]){
	case 'guardaryeditar':
		...
		$operacion ="Registrar Categoria"; $metodo="insert"; $ip = $_SERVER['REMOTE_ADDR']; $observacion='Nueva categoria '.$nombre;

		if (empty($idcategoria)){
			$rspta=$categoria->insertar($nombre,$descripcion);
			$rspta=$categoria->insertar_bitacora($operacion,$metodo,$user.'--'.$ip,$observacion); 
