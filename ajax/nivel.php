...
switch ($_GET["op"]){
	...
	$operacion ="Registrar Nivel"; $metodo="insert"; $ip = $_SERVER['REMOTE_ADDR']; $observacion='Nuevo Nivel '.$nombre;
		...
		if (empty($idnivel)){
			...
			$rspta=$nivel->insertar_bitacora($operacion,$metodo,$user.'--'.$ip,$observacion); 
		}
		else {
