...
Class Ingreso
{
	...
	public function ingresodetalle($idingreso){
		$sql="SELECT a.nombre as articulo,a.puntos,d.cantidad,d.precio_compra,d.precio_venta,(d.cantidad*d.precio_compra) as subtotal FROM detalle_ingreso d INNER JOIN articulo a ON d.idarticulo=a.idarticulo WHERE d.idingreso='$idingreso'";
		return ejecutarConsulta($sql);
	}
}
