...
<html>
  <head>
    ...
    <link rel="shortcut icon" href="../public/img/logo_herbalife.ico">
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="escritorio.php" class="logo">
          ...
          <span class="logo-lg"><b>Herbalife</b></span>
        </a>
              ...
              <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    ...
                    <p>
                      www.umg.edu.gt - Estudiante de Ingenieria en Sistemas
          ...
          <ul class="sidebar-menu">
            ...
            if ($_SESSION['almacen']==1)
            {
              ...
              <a href="#">
                ...
                <span>Control del Productos</span>
                <i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
                <li id="lArticulos"><a href="articulo.php"><i class="fa fa-circle-o"></i>Productos</a></li>
                <li id="lCategorias"><a href="categoria.php"><i class="fa fa-circle-o"></i> Categoria Producto </a></li>
              </ul>
            </li>';
            }
            ?>
            ...
            if ($_SESSION['compras']==1)
            {
              ...
              <ul class="treeview-menu">
                <li id="lIngresos"><a href="ingreso.php"><i class="fa fa-circle-o"></i>Ingreso</a></li>
                <li id="lProveedores"><a href="proveedor.php"><i class="fa fa-circle-o"></i> Registro de Proveedores</a></li>
              </ul>
            </li>';
            }
            ?>
            ...
            if ($_SESSION['acceso']==1)
            {
              ...
              <a href="#">
                <i class="fa fa-folder"></i> <span>Colaboradores</span>
                <i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
            ...
            <!--opcion de registro de niveles -->
            <?php 
            if ($_SESSION['acceso']==1)
            {
              echo '<li id="mNivel" class="treeview">
              <a href="#">
                <i class="fa fa-bars"></i> <span>Niveles</span>
                <i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
                <li id="lNivel"><a href="nivel.php"><i class="fa fa-circle-o"></i> Registro de niveles</a></li>
              </ul>
            </li>';
            }
            ?>
            ...
            <li>
              <a href="acerca.php">
                ...
                <small class="label pull-right bg-yellow">Información </small>
              </a>
            </li>          
          </ul>
        </section>
