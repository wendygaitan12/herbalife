                  ...
                  <div class="box">
                    ...
                    <div class="panel-body" id="formularioregistros">
                        <form name="formulario" id="formulario" method="POST">
                          ...
                          <!--Puntos-->
                          <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <label>Puntos de Inicio:</label>
                            <input type="number"class="form-control" name="puntos" id="puntos" disabled="true" placeholder="0" value="0"> 
                          </div>
  
                            <!--Persona Referencia -->
                          <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                             <label>Persona Referencia</label>
                              <select id="idreferencia" name="idreferencia" class="form-control selectpicker" data-live-search="true" required></select>
                              </div>    
                          </div>
